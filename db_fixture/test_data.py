...
# create data
'''  datas里面的create_time是默认读取的当前时间，要自己给的话，每条sql都需要加入下面这句：
     'create_time': '2017-10-22 14:00:00'   '''
datas = {
    'sign_event': [
        {'id': 1, 'name': '红米Pro发布会', '`limit`': 2000, 'status': 1, 'address': '北京会展中心',
         'start_time': '2018-10-20 14:00:00', 'create_time': '2017-10-20 14:00:00'},
        ...
        {'id': 4, 'name': '发布会已结束', '`limit`': 2000, 'status': 1, 'address': '北京会展中心',
         'start_time': '2001-08-20 14:00:00', 'create_time': '2017-10-20 14:00:00'},
